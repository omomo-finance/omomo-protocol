...
impl Contract {
    ...
    fn get_params_by_action_mut(&mut self, action: ActionType) -> (&mut LookupMap<AccountId, LookupMap<AccountId, Balance>>, StorageKeys) {
        // return mutable parameters respective to ActionType
        match action {
...
mod tests {
    ...
    pub(crate) fn init_test_env() -> (Contract, AccountId, AccountId, AccountId) {
    ...
    pub(crate) fn get_context(predecessor_account_id: AccountId) -> VMContextBuilder {
