...
mod tests {
    ...
    fn init() -> (Contract, AccountId, AccountId) {
        ...
        controller_contract.add_market(
            utoken_address_near.clone(),
            dtoken_address_near.clone(),
        ...
        controller_contract.add_market(
            utoken_address_eth.clone(),
            dtoken_address_eth.clone(),
            ticker_id_eth.clone()
        );
        ...
        prices.push(Price {
            ticker_id: ticker_id_near.clone(),
            value: U128(20000),
            volatility: U128(80),
            fraction_digits: 4
        });
        prices.push(Price {
            ticker_id: ticker_id_eth.clone(),
            value: U128(20000),
            volatility: U128(100),
            fraction_digits: 4
        });
