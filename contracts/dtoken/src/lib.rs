...
trait InternalTokenInterface {
    ...
    fn borrow_balance_of_callback(&mut self, token_amount: WBalance, account_to_borrow: AccountId) -> PromiseOrValue<WBalance>;
    fn make_borrow_callback(&mut self, token_amount: WBalance, account_to_borrow: AccountId) -> PromiseOrValue<WBalance>;
    fn repay_balance_of_callback(&mut self, token_amount: WBalance) -> PromiseOrValue<WBalance>;
    fn borrow_ft_transfer_callback(&mut self, token_amount: WBalance, account_to_borrow: AccountId) -> PromiseOrValue<WBalance>;
