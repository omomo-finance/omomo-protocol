...
#[cfg_attr(feature = "enable-peepmatic", derive(serde::Serialize, serde::Deserialize))]
pub enum Opcode {
...
const OPCODE_FORMAT: [InstructionFormat; 261] = [
...
const OPCODE_CONSTRAINTS: [OpcodeConstraints; 261] = [
