...
# # Deposit
# near call $USDT_TOKEN ft_transfer_call '{"receiver_id": "'$CONTRACT_ID'", "amount": "50000000000000000000000000000", "msg": "{\"Deposit\": {\"token\": \"'$USDT_TOKEN'\"}}"}' --accountId $USER_ACCOUNT --depositYocto 1 --gas 300000000000000
...
#     "left_point": -6920,
#     "right_point": -6880,
#     "amount": "65000000000000000000000000",
...
# near call $DEX_ACCOUNT remove_liquidity '{
#     "lpt_id": "usdt.develop.v1.omomo-finance.testnet|wnear.develop.v1.omomo-finance.testnet|2000#192",
#     "amount": "1150848963715625344146164",
#     "min_amount_x": "0",
#     "min_amount_y": "0"
# }' --accountId $CONTRACT_ID --gas 300000000000000
