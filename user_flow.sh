...
near call --depositYocto 1 --gas 242816471680 weth_beta.nearlend.testnet ft_transfer_call '{"receiver_id": "dweth_beta.nearlend.testnet", "amount": "100", "msg":"{\"action\": \"SUPPLY\"}"}' --accountId nearlend.testnet