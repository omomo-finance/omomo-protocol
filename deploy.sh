...
near create-account usdt_beta.nearlend.testnet --masterAccount nearlend.testnet --initialBalance 10 "$@"
near create-account dusdt_beta.nearlend.testnet --masterAccount nearlend.testnet --initialBalance 10 "$@"
...
near deploy dusdt_beta.nearlend.testnet --wasmFile ./contracts/target/wasm32-unknown-unknown/release/dtoken.wasm --initFunction 'new_with_config' --initArgs '{"owner_id": "nearlend.testnet", "underlying_token_id": "usdt_beta.nearlend.testnet", "controller_account_id": "controller_beta.nearlend.testnet", "initial_exchange_rate": "10000", "interest_rate_model": {"kink": "8000", "multiplier_per_block": "1", "base_rate_per_block": "1", "jump_multiplier_per_block": "2", "reserve_factor": "100", "rewards_config": []}}' "$@"
...
near view controller_beta.nearlend.testnet view_prices '{ "dtokens": ["dwnear_beta.nearlend.testnet", "dweth_beta.nearlend.testnet", "dusdt_beta.nearlend.testnet"] }' --accountId controller_beta.nearlend.testnet "$@"
