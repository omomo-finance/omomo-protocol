...
near call controller.omomo-finance.testnet add_market '{"asset_id": "wnear.omomo-finance.testnet", "dtoken": "dwnear.omomo-finance.testnet", "ticker_id": "wnear"}' --accountId omomo-finance.testnet 
